...
public class DatawebDomainNavigatorContentProvider implements ICommonContentProvider {
	...
	*/
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof DatawebDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier
					.getChildren(((DatawebDomainNavigatorItem) parentElement).getEObject()), parentElement);
		}
		return EMPTY_ARRAY;
	}
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new DatawebDomainNavigatorItem((EObject) objects[i], parentElement,
