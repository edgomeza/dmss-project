 ...
 * @generated
 */
public class PaginaCreacionNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PaginaCreacionNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.PaginaCreacion_2006, getParserElement(),
					DatawebVisualIDRegistry.getType(dataweb.diagram.edit.parts.PaginaCreacionNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
