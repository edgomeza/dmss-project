...
public class WrappingLabel5EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				DatawebVisualIDRegistry.getType(dataweb.diagram.edit.parts.WrappingLabel5EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.PaginaIndiceAtributosMostrados_4006,
