...
public class WrappingLabel8EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				DatawebVisualIDRegistry.getType(dataweb.diagram.edit.parts.WrappingLabel8EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.PaginaIndiceFiltrosAtributosFiltro_4009,
