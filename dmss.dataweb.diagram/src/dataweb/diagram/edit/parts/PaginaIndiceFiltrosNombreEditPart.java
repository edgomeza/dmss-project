 ...
 * @generated
 */
public class PaginaIndiceFiltrosNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PaginaIndiceFiltrosNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.PaginaIndiceFiltros_2003, getParserElement(),
					DatawebVisualIDRegistry
							.getType(dataweb.diagram.edit.parts.PaginaIndiceFiltrosNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
