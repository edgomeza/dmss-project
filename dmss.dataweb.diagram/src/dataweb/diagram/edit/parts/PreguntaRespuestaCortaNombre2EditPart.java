 ...
 * @generated
 */
public class PreguntaRespuestaCortaNombre2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PreguntaRespuestaCortaNombre2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.PreguntaRespuestaCorta_3008,
					getParserElement(), DatawebVisualIDRegistry
							.getType(dataweb.diagram.edit.parts.PreguntaRespuestaCortaNombre2EditPart.VISUAL_ID));
		}
		return parser;
	}
