...
public class WrappingLabel3EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				DatawebVisualIDRegistry.getType(dataweb.diagram.edit.parts.WrappingLabel3EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.PaginaFuentesRSS_4004, getParserElement(),
