 ...
 * @generated
 */
public class PaginaIndicePaginadaFiltradaNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PaginaIndicePaginadaFiltradaNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	protected Image getLabelIcon() {
		...
		return DatawebElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.PaginaIndicePaginadaFiltrada_2004,
					getParserElement(), DatawebVisualIDRegistry
							.getType(dataweb.diagram.edit.parts.PaginaIndicePaginadaFiltradaNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
