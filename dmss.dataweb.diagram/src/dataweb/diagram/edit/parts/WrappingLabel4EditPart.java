...
public class WrappingLabel4EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				DatawebVisualIDRegistry.getType(dataweb.diagram.edit.parts.WrappingLabel4EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.PaginaCRUDEntidad_4005, getParserElement(),
