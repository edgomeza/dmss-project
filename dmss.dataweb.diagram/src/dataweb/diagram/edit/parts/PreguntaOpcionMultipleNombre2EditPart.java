 ...
 * @generated
 */
public class PreguntaOpcionMultipleNombre2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PreguntaOpcionMultipleNombre2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.PreguntaOpcionMultiple_3006,
					getParserElement(), DatawebVisualIDRegistry
							.getType(dataweb.diagram.edit.parts.PreguntaOpcionMultipleNombre2EditPart.VISUAL_ID));
		}
		return parser;
	}
