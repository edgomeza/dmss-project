 ...
 * @generated
 */
public class EncuestaNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public EncuestaNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.Encuesta_2014, getParserElement(),
					DatawebVisualIDRegistry.getType(dataweb.diagram.edit.parts.EncuestaNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
