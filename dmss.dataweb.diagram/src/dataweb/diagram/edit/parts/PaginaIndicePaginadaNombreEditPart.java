 ...
 * @generated
 */
public class PaginaIndicePaginadaNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PaginaIndicePaginadaNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.PaginaIndicePaginada_2002, getParserElement(),
					DatawebVisualIDRegistry
							.getType(dataweb.diagram.edit.parts.PaginaIndicePaginadaNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
