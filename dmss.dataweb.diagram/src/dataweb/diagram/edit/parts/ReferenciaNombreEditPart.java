...
import dataweb.diagram.edit.policies.DatawebTextSelectionEditPolicy;
 ...
 * @generated
 */
public class ReferenciaNombreEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				DatawebVisualIDRegistry.getType(dataweb.diagram.edit.parts.ReferenciaNombreEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public ReferenciaNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new DatawebTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.Referencia_4001, getParserElement(),
					DatawebVisualIDRegistry.getType(dataweb.diagram.edit.parts.ReferenciaNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, DatawebEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ReferenciaLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ReferenciaLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ReferenciaLabelFigure() {
			this.setText("Referencia");
		}
