 ...
 * @generated
 */
public class PaginaDetalleNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PaginaDetalleNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.PaginaDetalle_2005, getParserElement(),
					DatawebVisualIDRegistry.getType(dataweb.diagram.edit.parts.PaginaDetalleNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
