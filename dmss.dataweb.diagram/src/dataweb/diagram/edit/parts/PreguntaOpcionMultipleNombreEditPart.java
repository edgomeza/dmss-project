 ...
 * @generated
 */
public class PreguntaOpcionMultipleNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PreguntaOpcionMultipleNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.PreguntaOpcionMultiple_3002,
					getParserElement(), DatawebVisualIDRegistry
							.getType(dataweb.diagram.edit.parts.PreguntaOpcionMultipleNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
