...
public class RolNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.Rol_2012, getParserElement(),
					DatawebVisualIDRegistry.getType(dataweb.diagram.edit.parts.RolNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
