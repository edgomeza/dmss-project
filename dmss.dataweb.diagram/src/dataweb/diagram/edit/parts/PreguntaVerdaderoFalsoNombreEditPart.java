 ...
 * @generated
 */
public class PreguntaVerdaderoFalsoNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PreguntaVerdaderoFalsoNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.PreguntaVerdaderoFalso_3004,
					getParserElement(), DatawebVisualIDRegistry
							.getType(dataweb.diagram.edit.parts.PreguntaVerdaderoFalsoNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
