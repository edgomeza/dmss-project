 ...
 * @generated
 */
public class PreguntaVerdaderoFalsoNombre2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PreguntaVerdaderoFalsoNombre2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.PreguntaVerdaderoFalso_3007,
					getParserElement(), DatawebVisualIDRegistry
							.getType(dataweb.diagram.edit.parts.PreguntaVerdaderoFalsoNombre2EditPart.VISUAL_ID));
		}
		return parser;
	}
