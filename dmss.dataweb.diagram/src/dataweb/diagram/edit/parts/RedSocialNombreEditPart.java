 ...
 * @generated
 */
public class RedSocialNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public RedSocialNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.RedSocial_2015, getParserElement(),
					DatawebVisualIDRegistry.getType(dataweb.diagram.edit.parts.RedSocialNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
