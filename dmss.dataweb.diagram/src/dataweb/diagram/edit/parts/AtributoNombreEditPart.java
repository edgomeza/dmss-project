...
public class AtributoNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.Atributo_3001, getParserElement(),
					DatawebVisualIDRegistry.getType(dataweb.diagram.edit.parts.AtributoNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
