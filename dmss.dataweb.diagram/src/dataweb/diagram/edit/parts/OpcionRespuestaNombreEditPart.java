 ...
 * @generated
 */
public class OpcionRespuestaNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public OpcionRespuestaNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.OpcionRespuesta_3003, getParserElement(),
					DatawebVisualIDRegistry
							.getType(dataweb.diagram.edit.parts.OpcionRespuestaNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
