 ...
 * @generated
 */
public class PreguntaRespuestaCortaNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PreguntaRespuestaCortaNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.PreguntaRespuestaCorta_3005,
					getParserElement(), DatawebVisualIDRegistry
							.getType(dataweb.diagram.edit.parts.PreguntaRespuestaCortaNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
