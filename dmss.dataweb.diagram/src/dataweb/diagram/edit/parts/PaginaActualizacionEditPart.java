...
import dataweb.diagram.edit.policies.PaginaActualizacionItemSemanticEditPolicy;
...
public class PaginaActualizacionEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PaginaActualizacionItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PaginaActualizacionNombreEditPart) {
			((PaginaActualizacionNombreEditPart) childEditPart)
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DatawebVisualIDRegistry.getType(PaginaActualizacionNombreEditPart.VISUAL_ID));
	}
	...
	*/
	 ...
	 * @generated
	 */
	public class PaginaActualizacionFigure extends RoundedRectangle {
