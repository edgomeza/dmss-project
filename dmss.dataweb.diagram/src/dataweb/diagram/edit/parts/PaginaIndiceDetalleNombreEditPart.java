 ...
 * @generated
 */
public class PaginaIndiceDetalleNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PaginaIndiceDetalleNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.PaginaIndiceDetalle_2001, getParserElement(),
					DatawebVisualIDRegistry
							.getType(dataweb.diagram.edit.parts.PaginaIndiceDetalleNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
