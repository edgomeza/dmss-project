 ...
 * @generated
 */
public class CuestionarioNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CuestionarioNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.Cuestionario_2013, getParserElement(),
					DatawebVisualIDRegistry.getType(dataweb.diagram.edit.parts.CuestionarioNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
