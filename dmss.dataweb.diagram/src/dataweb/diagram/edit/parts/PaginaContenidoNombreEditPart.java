 ...
 * @generated
 */
public class PaginaContenidoNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PaginaContenidoNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.PaginaContenido_2010, getParserElement(),
					DatawebVisualIDRegistry
							.getType(dataweb.diagram.edit.parts.PaginaContenidoNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
