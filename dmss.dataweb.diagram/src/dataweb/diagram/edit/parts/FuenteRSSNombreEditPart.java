 ...
 * @generated
 */
public class FuenteRSSNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FuenteRSSNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.FuenteRSS_2016, getParserElement(),
					DatawebVisualIDRegistry.getType(dataweb.diagram.edit.parts.FuenteRSSNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
