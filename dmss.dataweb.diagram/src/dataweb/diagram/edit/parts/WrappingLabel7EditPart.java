...
public class WrappingLabel7EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				DatawebVisualIDRegistry.getType(dataweb.diagram.edit.parts.WrappingLabel7EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.RolPaginasAccesibles_4008, getParserElement(),
