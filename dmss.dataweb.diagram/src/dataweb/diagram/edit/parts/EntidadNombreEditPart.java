...
public class EntidadNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.Entidad_2011, getParserElement(),
					DatawebVisualIDRegistry.getType(dataweb.diagram.edit.parts.EntidadNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
