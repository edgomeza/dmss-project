 ...
 * @generated
 */
public class PaginaBorradoNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PaginaBorradoNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DatawebParserProvider.getParser(DatawebElementTypes.PaginaBorrado_2008, getParserElement(),
					DatawebVisualIDRegistry.getType(dataweb.diagram.edit.parts.PaginaBorradoNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
