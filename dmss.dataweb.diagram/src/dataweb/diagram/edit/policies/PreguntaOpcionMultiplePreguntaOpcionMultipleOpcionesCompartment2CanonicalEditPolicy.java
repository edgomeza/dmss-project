 ...
 * @generated
 */
public class PreguntaOpcionMultiplePreguntaOpcionMultipleOpcionesCompartment2CanonicalEditPolicy
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return DatawebPackage.eINSTANCE.getPreguntaOpcionMultiple_Opciones();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DatawebNodeDescriptor> childDescriptors = DatawebDiagramUpdater
				.getPreguntaOpcionMultiplePreguntaOpcionMultipleOpcionesCompartment_7006SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return OpcionRespuestaEditPart.VISUAL_ID == DatawebVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<DatawebNodeDescriptor> childDescriptors = DatawebDiagramUpdater
				.getPreguntaOpcionMultiplePreguntaOpcionMultipleOpcionesCompartment_7006SemanticChildren(
