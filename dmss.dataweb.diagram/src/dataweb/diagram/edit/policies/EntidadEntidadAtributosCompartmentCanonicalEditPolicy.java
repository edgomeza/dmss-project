...
public class EntidadEntidadAtributosCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return DatawebPackage.eINSTANCE.getEntidad_Atributos();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DatawebNodeDescriptor> childDescriptors = DatawebDiagramUpdater
				.getEntidadEntidadAtributosCompartment_7001SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return AtributoEditPart.VISUAL_ID == DatawebVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<DatawebNodeDescriptor> childDescriptors = DatawebDiagramUpdater
				.getEntidadEntidadAtributosCompartment_7001SemanticChildren((View) getHost().getModel());
