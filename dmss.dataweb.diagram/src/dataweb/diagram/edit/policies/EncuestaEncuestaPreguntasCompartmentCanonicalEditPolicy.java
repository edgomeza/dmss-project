 ...
 * @generated
 */
public class EncuestaEncuestaPreguntasCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return DatawebPackage.eINSTANCE.getEncuesta_Preguntas();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DatawebNodeDescriptor> childDescriptors = DatawebDiagramUpdater
				.getEncuestaEncuestaPreguntasCompartment_7005SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == PreguntaOpcionMultiple2EditPart.VISUAL_ID
				|| visualID == PreguntaVerdaderoFalso2EditPart.VISUAL_ID
				|| visualID == PreguntaRespuestaCorta2EditPart.VISUAL_ID;
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<DatawebNodeDescriptor> childDescriptors = DatawebDiagramUpdater
				.getEncuestaEncuestaPreguntasCompartment_7005SemanticChildren((View) getHost().getModel());
