 ...
 * @generated
 */
public class OpcionRespuestaItemSemanticEditPolicy extends DatawebBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public OpcionRespuestaItemSemanticEditPolicy() {
		super(DatawebElementTypes.OpcionRespuesta_3003);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (DatawebVisualIDRegistry
					.getVisualID(incomingLink) == PreguntaOpcionMultipleRespuestaCorrectaEditPart.VISUAL_ID) {
