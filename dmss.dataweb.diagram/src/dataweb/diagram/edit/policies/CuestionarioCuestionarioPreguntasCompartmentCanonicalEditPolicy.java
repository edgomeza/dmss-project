 ...
 * @generated
 */
public class CuestionarioCuestionarioPreguntasCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return DatawebPackage.eINSTANCE.getCuestionario_Preguntas();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DatawebNodeDescriptor> childDescriptors = DatawebDiagramUpdater
				.getCuestionarioCuestionarioPreguntasCompartment_7003SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == PreguntaOpcionMultipleEditPart.VISUAL_ID
				|| visualID == PreguntaVerdaderoFalsoEditPart.VISUAL_ID
				|| visualID == PreguntaRespuestaCortaEditPart.VISUAL_ID;
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<DatawebNodeDescriptor> childDescriptors = DatawebDiagramUpdater
				.getCuestionarioCuestionarioPreguntasCompartment_7003SemanticChildren((View) getHost().getModel());
