 ...
 * @generated
 */
public class CuestionarioItemSemanticEditPolicy extends DatawebBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public CuestionarioItemSemanticEditPolicy() {
					...
					case PreguntaOpcionMultipleEditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							...
							if (DatawebVisualIDRegistry.getVisualID(
									outgoingLink) == PreguntaOpcionMultipleRespuestaCorrectaEditPart.VISUAL_ID) {
