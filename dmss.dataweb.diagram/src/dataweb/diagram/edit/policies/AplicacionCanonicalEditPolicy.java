...
public class AplicacionCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected Set getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize.add(DatawebPackage.eINSTANCE.getAplicacion_Paginas());
			myFeaturesToSynchronize.add(DatawebPackage.eINSTANCE.getAplicacion_Entidades());
			myFeaturesToSynchronize.add(DatawebPackage.eINSTANCE.getAplicacion_Roles());
			myFeaturesToSynchronize.add(DatawebPackage.eINSTANCE.getAplicacion_Cuestionarios());
			myFeaturesToSynchronize.add(DatawebPackage.eINSTANCE.getAplicacion_Encuestas());
			myFeaturesToSynchronize.add(DatawebPackage.eINSTANCE.getAplicacion_RedesSociales());
			myFeaturesToSynchronize.add(DatawebPackage.eINSTANCE.getAplicacion_FuentesRSS());
		}
	...
	*/
	private Collection<DatawebLinkDescriptor> collectAllLinks(View view, Domain2Notation domain2NotationMap) {
		...
		case PaginaIndiceDetalleEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DatawebDiagramUpdater.getPaginaIndiceDetalle_2001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case PaginaIndicePaginadaEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DatawebDiagramUpdater.getPaginaIndicePaginada_2002ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case PaginaIndiceFiltrosEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DatawebDiagramUpdater.getPaginaIndiceFiltros_2003ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case PaginaIndicePaginadaFiltradaEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DatawebDiagramUpdater.getPaginaIndicePaginadaFiltrada_2004ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case PaginaDetalleEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DatawebDiagramUpdater.getPaginaDetalle_2005ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case PaginaCreacionEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DatawebDiagramUpdater.getPaginaCreacion_2006ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case PaginaActualizacionEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DatawebDiagramUpdater.getPaginaActualizacion_2007ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case PaginaBorradoEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DatawebDiagramUpdater.getPaginaBorrado_2008ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case PaginaHomeEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DatawebDiagramUpdater.getPaginaHome_2009ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case PaginaContenidoEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DatawebDiagramUpdater.getPaginaContenido_2010ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case EntidadEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DatawebDiagramUpdater.getEntidad_2011ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case RolEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DatawebDiagramUpdater.getRol_2012ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case CuestionarioEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DatawebDiagramUpdater.getCuestionario_2013ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case EncuestaEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DatawebDiagramUpdater.getEncuesta_2014ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case RedSocialEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DatawebDiagramUpdater.getRedSocial_2015ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case FuenteRSSEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DatawebDiagramUpdater.getFuenteRSS_2016ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case AtributoEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DatawebDiagramUpdater.getAtributo_3001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case PreguntaOpcionMultipleEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DatawebDiagramUpdater.getPreguntaOpcionMultiple_3002ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case OpcionRespuestaEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DatawebDiagramUpdater.getOpcionRespuesta_3003ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case PreguntaVerdaderoFalsoEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DatawebDiagramUpdater.getPreguntaVerdaderoFalso_3004ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case PreguntaRespuestaCortaEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DatawebDiagramUpdater.getPreguntaRespuestaCorta_3005ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case PreguntaOpcionMultiple2EditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DatawebDiagramUpdater.getPreguntaOpcionMultiple_3006ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case PreguntaVerdaderoFalso2EditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DatawebDiagramUpdater.getPreguntaVerdaderoFalso_3007ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case PreguntaRespuestaCorta2EditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DatawebDiagramUpdater.getPreguntaRespuestaCorta_3008ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case ReferenciaEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DatawebDiagramUpdater.getReferencia_4001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
