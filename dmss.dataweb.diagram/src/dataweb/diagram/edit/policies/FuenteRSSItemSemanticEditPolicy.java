 ...
 * @generated
 */
public class FuenteRSSItemSemanticEditPolicy extends DatawebBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public FuenteRSSItemSemanticEditPolicy() {
		super(DatawebElementTypes.FuenteRSS_2016);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (DatawebVisualIDRegistry.getVisualID(incomingLink) == PaginaFuentesRSSEditPart.VISUAL_ID) {
