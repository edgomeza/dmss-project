        ...
        case 'opcion_multiple':
            ...
            if (correctAnswerContainerSpecific) {
                correctAnswerContainerSpecific.innerHTML = `
                    ...
                    <div class="field-help">Seleccione cuál es la respuesta correcta entre las opciones</div>
                `;
            }
            break;
        ...
        case 'verdadero_falso':
            ...
            if (correctAnswerContainerSpecific) {
                correctAnswerContainerSpecific.innerHTML = `
                    ...
                    <div class="field-help">Indique si la afirmación es verdadera o falsa</div>
                `;
            }
            break;
        ...
        case 'respuesta_corta':
            ...
            if (correctAnswerContainerSpecific) {
                correctAnswerContainerSpecific.innerHTML = `
                    ...
                    <div class="field-help">Introduzca la respuesta exacta que se debe considerar correcta. Las respuestas del usuario se compararán con esta respuesta.</div>
                `;
            }
            break;
...
/**
 * Elimina una opción de la lista y actualiza el selector de respuesta correcta
 */
...
async function saveSurvey() {
    try {
        ...
        const surveyData = {
            ...
            tipoRepresentacion: formData.get('tipoRepresentacion'),
            preguntas: []
        };
        ...
        const encuestaId = await db.create('ENCUESTAS', {
            ...
            tipo_representacion: surveyData.tipoRepresentacion
        });
