...
/**
 * Entry point of the 'GenerateDocumentation' generation module.
 *
 * @generated
 */
public class GenerateDocumentation extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/eclipse/acceleo/module/DataWeb/main/generateDocumentation";
     ...
     * @generated
     */
    public GenerateDocumentation(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public GenerateDocumentation(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                GenerateDocumentation generator = new GenerateDocumentation(modelURI, folder, arguments);
