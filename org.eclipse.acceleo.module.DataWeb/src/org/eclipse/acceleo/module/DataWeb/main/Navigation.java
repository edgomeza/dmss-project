...
/**
 * Entry point of the 'Navigation' generation module.
 *
 * @generated
 */
public class Navigation extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/eclipse/acceleo/module/DataWeb/main/navigation";
     ...
     * @generated
     */
    public Navigation(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public Navigation(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                Navigation generator = new Navigation(modelURI, folder, arguments);
